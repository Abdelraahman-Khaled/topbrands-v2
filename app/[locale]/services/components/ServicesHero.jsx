    ...
    <section className="relative min-h-[85vh] flex items-end overflow-hidden" style={{ background: "#0f0f0f" }}>
      ...
      {imageUrl && (
        <div className="absolute inset-0 z-0">
          <img src={imageUrl} alt={title || "Services"} className="w-full h-full object-cover" />
          <div className="absolute inset-0" style={{ background: "linear-gradient(to right, rgba(0,0,0,0.85) 40%, rgba(0,0,0,0.4) 100%)" }} />
        </div>
      )}
      ...
      <div className="relative z-20 w-full px-10 sm:px-14 lg:px-20 xl:px-28 pt-44 pb-24">
        ...
        {badge && (
          ...
          >
            <span
              className="text-xs font-bold tracking-[4px] uppercase font-mono"
